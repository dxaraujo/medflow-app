...
import { ATTENDANCE_BAR_DATA, type AttendanceMonthPoint } from "@/data/attendance-series"

const PEAK_MONTH_LABEL = "Jul"
        ...
        >
          <XAxis
            ...
            tick={({ x, y, payload }) => {
              ...
              const isPeak = label === PEAK_MONTH_LABEL
              return (
                <text
                  x={x}
                  y={y}
          ...
          <Tooltip
            ...
            content={({ active, payload }) => {
              ...
              const row = payload[0].payload as AttendanceMonthPoint
              return (
          ...
          >
            {ATTENDANCE_BAR_DATA.map((entry, index) => (
              <Cell
                key={entry.month}
